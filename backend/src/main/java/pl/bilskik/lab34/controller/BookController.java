...
public class BookController {
    ...
    @PostMapping
    public  ResponseEntity<ResponseMessage> saveBook(@RequestBody @Valid BookDTO bookDTO) {
        return new ResponseEntity<>(new ResponseMessage(bookService.saveBook(bookDTO)), HttpStatus.CREATED);
    }
